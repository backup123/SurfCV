...
int main(int argc, char* argv[])
{
    const char* keys =
        ...
        "{ l left     | logo.jpg          | specify left image  }"
        "{ r right    | logo_in_scene.jpg | specify right image }"
    ...
    imread("logo.png", IMREAD_GRAYSCALE).copyTo(img1);
    if(img1.empty())
    {
    ...
    imread("logo_in_scene.png", IMREAD_GRAYSCALE).copyTo(img2);
    if(img2.empty())
    {
